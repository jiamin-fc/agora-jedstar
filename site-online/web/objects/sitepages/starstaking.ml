<div class="intro-container">
	...
	<div class="index-container">
					...
					<div class="stake-form">
						...
						<div class="form-area">
							...
							<div class="kdarena">
								<p class="kdarenatitle">KDArena</p>
								<ul>
									<li>Everything  in 30 days; plus</li>
					...
					<div class="stake-form">
						...
						<div class="form-area">
							...
							<div class="kdarena">
								<p class="kdarenatitle">KDArena</p>
								<ul>
									<li>Everything in 60 days; plus </li>
		...
		<div id = "info-popup" class = "popup">
			...
			<div id = "stake-button-div" class = "authorize-button-popup popup-button-hidden">
				<button id = "stake-button-popup"><div id = "stake-button-text" class = "capitalise">Stake</div></button>
			</div>
		</div>
	</div>